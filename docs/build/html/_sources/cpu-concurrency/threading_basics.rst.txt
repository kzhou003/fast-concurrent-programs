...
thread = threading.Thread(target=download*file)
thread.start()
...
│ thread = Thread(target=worker*func)                     │
...
threads = []
for task in tasks:
    thread = threading.Thread(target=do*task, args=(task,))
...
===========================================
thread = threading.Thread(target=save*to*database)
thread.start()
...
threads = []
for url in urls:
    thread = threading.Thread(target=fetch*url, args=(url, results))
