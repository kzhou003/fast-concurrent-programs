...
4. **Removed ``add_done*callback()`` pattern**
   - Old: ``future.add_done*callback(got_result)``
...
python3 10*asyncio_and*futures.py <num1> <num2>
::
...
python3 10*asyncio_and*futures.py 10 5
::
...
python3 10*asyncio_and*futures.py 100 7
::
